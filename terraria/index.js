...
function CreateLevel(main) {
    ...
    var flatness = 0.75; //original 0.75
...
function GameOverScreen(main) {
    ...
    new Text(main.context, 'White Wolf Programming', 9, main.canvas.height - 14, 'normal 13px/1 ' + main.fontFamily, light, 'left')
}
...
function Main() {
    this.blockSize = 16;
    this.levelWidth = 500; //orginal = 500
    ...
    this.dayLength = 480 * 30; //original 480 * 60
    this.blocks = {
        white: '#FFFFFF',
        black: '#000000',
        yellow: '#FFFF00',
...
function MenuScreen(main) {
    ...
    var medium = 'rgba(0,0,0,0.5)';
    var light = 'rgba(0,0,0,0.3)';
    new Text(main.context, 'Terraria Online', 9, 18, 'normal 21px/1 ' + main.fontFamily, light, 'left');
...
function PlayerHandler(main) {
    ...
    this.actions = [{
        ...
        reload: 4,
        count: -1,
        type: main.blockInt.blue
    },{
        name: 'Build red',
        reload: 4,
        count: -1,
        type: main.blockInt.red
    },{
        name: 'Build white',
        reload: 4,
        count: -1,
        type: main.blockInt.white
    },{
        name: 'Build Yellow',
        reload: 4,
        count: -1,
        type: main.blockInt.yellow
    },{
        name: 'Build Black',
        reload: 4,
        count: -1,
        type: main.blockInt.black
    },{
        name: 'Build green',
        reload: 4,
        count: -1,
        type: main.blockInt.green
    },{
        name: 'Build Dirt',
        reload: 4,
        count: -1,
